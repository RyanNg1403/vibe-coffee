...
- **rain_heavy** — "Ambience, Rain, Heavy, A.wav" by InspectorJ (www.jshaw.co.uk) — CC BY 4.0 (https://creativecommons.org/licenses/by/4.0/) — [source](https://freesound.org/people/InspectorJ/sounds/321173/)
- **rain_light** — "AMB_M_City_Rain_Light (light city rain ambience)" by conleec — CC0 1.0 Public Domain Dedication (http://creativecommons.org/publicdomain/zero/1.0/) — [source](https://freesound.org/people/conleec/sounds/171980/)
- **rain_steady** — "Moderate_rain_ext (exterior moderate rain)" by AMCINGSOUNDS — CC0 1.0 Public Domain Dedication (http://creativecommons.org/publicdomain/zero/1.0/) — [source](https://freesound.org/people/AMCINGSOUNDS/sounds/708557/)
...
- **char_matt** — "Characters Matt (rigged; Idle/Walk/Run/Wave clips - standing cast only)" by Quaternius — CC0 1.0 (Public Domain) — [source](https://poly.pizza/m/66kQ4dBBC7)
- **char_wcasual** — "Woman Casual (rigged; Idle/Walk/Run/Sitting/Clapping clips)" by Quaternius — CC0 1.0 (Public Domain) — [source](https://poly.pizza/m/jpKRgGDxhk)
- **char_wdress** — "Woman in Dress (rigged; Idle/Walk/Run/Sitting/Clapping clips)" by Quaternius — CC0 1.0 (Public Domain) — [source](https://poly.pizza/m/zMyPlQXBzq)
...
- **pet_cat** — "Cat (rigged; Idle/Walk/Headbutt/Idle_Eating/Death clips)" by Quaternius — CC0 1.0 (Public Domain) — [source](https://poly.pizza/m/qKICY6xla2)
- **pet_dog** — "Shiba Dog (rigged; Idle/Walk/Eating/Death clips)" by Quaternius — CC0 1.0 (Public Domain) — [source](https://poly.pizza/m/wpkGeoyfIP)
...
- **plant_cacti** — "Small Cacti Pot" by Isa Lousberg — CC0 1.0 (Public Domain) — [source](https://poly.pizza/m/vCLyYaeXZp)
- **plant_fern** — "Fern" by Danni Bittman — CC BY 3.0 (https://creativecommons.org/licenses/by/3.0/) - credit Danni Bittman — [source](https://poly.pizza/m/6ttropQuVzQ)
- **plant_monstera** — "Large Monstera Plant" by Isa Lousberg — CC0 1.0 (Public Domain) — [source](https://poly.pizza/m/kZQ2WmnJFI)
- **plant_pothos** — "Pothos Plant Large" by Isa Lousberg — CC0 1.0 (Public Domain) — [source](https://poly.pizza/m/i7CfuCzaoo)
- **plant_pothos_vine** — "Pothos Vine Large" by Isa Lousberg — CC0 1.0 (Public Domain) — [source](https://poly.pizza/m/HG1d091bLo)
- **plant_small** — source metadata missing (see git history of tools/sound-credits.json)
- **plant_snake** — "Sansevieria Plant" by Isa Lousberg — CC0 1.0 (Public Domain) — [source](https://poly.pizza/m/pdSNJNVbO9)
- **plant_succulent** — "Succulent Pot" by Isa Lousberg — CC0 1.0 (Public Domain) — [source](https://poly.pizza/m/y3zjCa6BeR)
...
- **tree_park_a** — "Tree" by Quaternius — CC0 1.0 (Public Domain) — [source](https://poly.pizza/m/2paAm1ja4w)
- **tree_park_b** — "Tree" by Quaternius — CC0 1.0 (Public Domain) — [source](https://poly.pizza/m/9nvGuZlbpE)
