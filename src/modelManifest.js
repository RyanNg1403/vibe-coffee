...
export const MODEL_MANIFEST = {
  ...
  char_matt: { url: '/models/char_matt.glb' },
  char_wcasual: { url: '/models/char_wcasual.glb' },
  char_wdress: { url: '/models/char_wdress.glb' },
  ...
  plant_cacti: { url: '/models/plant_cacti.glb' },
  plant_fern: { url: '/models/plant_fern.glb' },
  plant_monstera: { url: '/models/plant_monstera.glb' },
  plant_pothos: { url: '/models/plant_pothos.glb' },
  plant_pothos_vine: { url: '/models/plant_pothos_vine.glb' },
  plant_small: { url: '/models/plant_small.glb' },
  plant_snake: { url: '/models/plant_snake.glb' },
  plant_succulent: { url: '/models/plant_succulent.glb' },
  ...
  tree_park_a: { url: '/models/tree_park_a.glb' },
  tree_park_b: { url: '/models/tree_park_b.glb' },
